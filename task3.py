...
tk.Label(root, text="Username:", bg="violet").grid(row=0, column=0, sticky="w", padx=10, pady=5)
username_entry = tk.Entry(root, width=30)
username_entry.grid(row=0, column=1, padx=10, pady=5)

tk.Label(root, text="Password Length:", bg="violet").grid(row=1, column=0, sticky="w", padx=10, pady=5)
length_entry = tk.Entry(root, width=30)

length_entry.grid(row=1, column=1, padx=10, pady=5)

tk.Label(root, text="Background Color (e.g., lightsteelblue):", bg="violet").grid(row=2, column=0, sticky="w", padx=10, pady=5)
color_entry = tk.Entry(root, width=30)
color_entry.grid(row=2, column=1, padx=10, pady=5)

password_label = tk.Label(root, text="Generated Password: ", bg="lightsteelblue")
password_label.grid(row=3, column=0, columnspan=2, padx=10, pady=10)

accept_button = tk.Button(root, text="Accept", bg="#f8ecdf", command=accept_action)
accept_button.grid(row=4, column=0, padx=10, pady=5)

reset_button = tk.Button(root, text="Reset", bg="thistle",  command=reset_action)
reset_button.grid(row=4, column=1, padx=10, pady=5)

color_button = tk.Button(root, text="Set Background Color", bg="mediumpurple", command=set_background_color)
